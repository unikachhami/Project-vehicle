...
class ModelEvaluation:
    ...
    def _map_gender_column(self,df):
        logging.info("Mapping gender column into binary variable")
    ...
    def evaluate_model(self):
        try:
            ...
            logging.info("Test data loaded and now transforming")
            ...
            if best_model is not None:
                ...
                logging.info("Predicting f1 score for production model")
    ...
    def initiate_model_evaluation(self):
        try:
            logging.info("Initialied model function started")
